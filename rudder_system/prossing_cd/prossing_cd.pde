...
void drawObject() {
  ...
  pixsDistance = map(iDistance, 0, 400, 0, (width-width*0.505)); // covers the distance from the sensor from cm to pixels
...
void drawText() { // draws the texts on the screen
  ...
  textSize(40);
  text("Rocky's Experiment", width-width*0.875, height-height*0.0277);
